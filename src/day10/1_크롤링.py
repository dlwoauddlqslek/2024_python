...
'''
    ...
    [3] 파싱 메소드, 속성
        ...
        4. .select()
            ...
            .태그명 : 해당 태그들의 첫번재태그 추출
            .text  : 마크업 사이의 문자열 반환, 자식,자손 가능, 주로 중첩텍스트
            .string : 마크업 사의 문자열, 자식만 가능, 자손 불가능, 주로 단일텍스트
...
# [7] 반복문과 같이 활용
for div in htmlObj.select('div'): # 모든 div를 추출해서 리스트 반환 후 리스트 만큼 반복문 처리
...
print(soup.find('ul',attrs={'class':'brand'}))
