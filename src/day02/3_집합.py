...
print(s1) #{1,2,3}
s2=set("Hello")
print(s2) #{'H', 'l', 'e', 'o'}, 실행 할때마다 순서는 랜덤으로 배치

#(2) 집합은 인덱싱이 없다, 리스트/튜플로 타입 변환 후 인덱싱 사용.
l1=list(s1)     # list(요소): 해당 요소를 리스트 타입으로 반환 함수
print(l1)       #[1,2,3]
t1=tuple(s1)    # list(요소): 해당 요소를 튜플 타입으로 반환 함수
print(t1)       #(1,2,3)
...
# 2. 합집합, |(shift + 원화기호) 1.집합1 | 집합2 , 2.집합1.union(집합2)
