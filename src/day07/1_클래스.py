    ...
    # 객체? 추상적개념, 물리적개념으로 특성(변수)과 행위(함수)를 정의한것
#[1] 클래스 구조 만들기
#(1) 간단한 클래스
class FourCal:
...
class FourCal: #(1) 클래스내 메소드 선언
    ...
    def __init__(self,first,second):
        ...
        self.second=second
    # 함수 코드는 객체들이 공유 사용
    def setdata(self,first,second): # 함수/메소드 정의 # 매개변수란? 함수 호출시 전달되는 인자값을 저장하는 변수
    ...
    def add(self):
        ...
        return result
    def mul(self):
        result=self.first*self.second # result 변수는 지역변수(함수내에서만 사용되고 함수 종료시 사라짐)
        return result
    def sub(self):
...
# print(a.first)              # 객체내 필드값 호출
# print(a.second)
# print(a.add()); print(a.mul()); print(a.sub()); print(a.div())
#
# b=FourCal() # (3)객체 생성, a에 저장된 객체와 b에 저장된 객체는 다르다(타입은 동일)
# b.setdata(3,7)
# print(b.first)
# print(b.second)
...
#[5] 클래스 변수
    # 객체 변수     # 객체 마다의 사용되는 변수 # 객체변수명.변수명 # 필드, 멤버변수라고도 한다.
