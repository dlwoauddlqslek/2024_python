...
BUFFER_SIZE = 1000 # 버퍼란? 데이터 이동간 임시 저장 공간
    # 셔플 할때 버퍼에 1000개를 가져와서 임시로 저장하는 공간이다.
...
# 한번 호출한 검증데이터는 메모리에 기록하여 다음에 호출시 빠르게 접근할 수 있도록 하는 함수
